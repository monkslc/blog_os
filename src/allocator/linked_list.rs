...
impl LinkedListAllocator {
    ...
    unsafe fn add_free_region(&mut self, addr: usize, size: usize) {
        // ensure that the freed regions is capable of holding ListNode
    ...
    /// Looks for a free regions with the given size and alignment and removes it from the list
    ///
    ...
    /// Try to use the given region for an allocation with teh given size and alignment.
    ///
